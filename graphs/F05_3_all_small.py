"""
F05-3-all-small: Fuel Consumption Combined(Small)
"""
...
layout = html.Div([
    html.Div([
        dcc.Graph(id='me_foc_history_graph_all_small',
                  className="nine columns",
                  style={'height': '95vh'},
                  config={'displayModeBar': False})
    ]),
    html.Div([
        dcc.Graph(id='me_foc_sum_graph_all_small',
...
@app.callback(
    [Output('me_foc_history_graph_all_small', 'figure'),
     Output('me_foc_sum_graph_all_small', 'figure')],
