...
layout = html.Div([
    html.Div([
        dcc.Graph(id='sog_curent_bf_rpm_history_graph_all',
                  className="nine columns",
                  style={'height': '95vh'})
    ]),
    html.Div([
        dcc.Graph(id='sog_bf_avg_graph_all',
...
@app.callback(
    [Output('sog_curent_bf_rpm_history_graph_all', 'figure'),
     Output('sog_bf_avg_graph_all', 'figure')],
...
def update_figure(n_intervals):
    ...
    if df.empty:
        ...
        df = data.read_csv('fig_data/F05_1_all.csv')
