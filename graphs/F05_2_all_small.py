"""
F05-2-all-small: RPM/SLIP/ME LOAD% Combined(Small)
...
layout = html.Div([
    html.Div([
        dcc.Graph(id='eng_rpm_slip_history_graph_all_small',
                  className="nine columns",
                  style={'height': '95vh'},
                  config={'displayModeBar': False})
    ]),
    html.Div([
        dcc.Graph(id='eng_rpm_slip_avg_graph_all_small',
...
@app.callback(
    [Output('eng_rpm_slip_history_graph_all_small', 'figure'),
     Output('eng_rpm_slip_avg_graph_all_small', 'figure')],
