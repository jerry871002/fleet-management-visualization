...
layout = html.Div([
    dcc.Graph(id='propeller_performance_forecast_small_graph',
...
@app.callback(
    Output('propeller_performance_forecast_small_graph', 'figure'),
...
def update_figure(n_intervals):
    ...
    # x2, y2 = data.linear_reg_date_manual(df_draw_2['oldstartdatetime'], df_draw_2['propeller_quotient'], -1.158e-09, 2.342)
